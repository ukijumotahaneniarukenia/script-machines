...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-001 /bin/bash -c 'echo "deb http://ftp.jaist.ac.jp/pub/Linux/ubuntu bionic main" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-003 /bin/bash -c 'echo "deb http://ftp.jaist.ac.jp/pub/Linux/ubuntu bionic main" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-004 /bin/bash -c 'echo "deb http://ftp.jaist.ac.jp/pub/Linux/ubuntu bionic main" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-001 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic main restricted" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-003 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic main restricted" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-004 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic main restricted" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-001 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic-updates main restricted" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-003 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic-updates main restricted" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-004 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic-updates main restricted" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-001 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic universe" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-003 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic universe" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-004 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic universe" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-001 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic-updates universe" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-003 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic-updates universe" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-004 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic-updates universe" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-001 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic multiverse" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-003 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic multiverse" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-004 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic multiverse" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-001 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic-updates multiverse" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-003 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic-updates multiverse" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-004 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic-updates multiverse" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-001 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic-backports main restricted universe multiverse" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-003 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic-backports main restricted universe multiverse" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-004 /bin/bash -c 'echo "deb http://jp.archive.ubuntu.com/ubuntu/ bionic-backports main restricted universe multiverse" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-001 /bin/bash -c 'echo "deb http://security.ubuntu.com/ubuntu bionic-security main restricted" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-003 /bin/bash -c 'echo "deb http://security.ubuntu.com/ubuntu bionic-security main restricted" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-004 /bin/bash -c 'echo "deb http://security.ubuntu.com/ubuntu bionic-security main restricted" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-001 /bin/bash -c 'echo "deb http://security.ubuntu.com/ubuntu bionic-security universe" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-003 /bin/bash -c 'echo "deb http://security.ubuntu.com/ubuntu bionic-security universe" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-004 /bin/bash -c 'echo "deb http://security.ubuntu.com/ubuntu bionic-security universe" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-001 /bin/bash -c 'echo "deb http://security.ubuntu.com/ubuntu bionic-security multiverse" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
...
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-003 /bin/bash -c 'echo "deb http://security.ubuntu.com/ubuntu bionic-security multiverse" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
cd /var/lib/machines && machinectl shell root@vir-ubuntu-18-04-004 /bin/bash -c 'echo "deb http://security.ubuntu.com/ubuntu bionic-security multiverse" | tee -a /etc/apt/sources.list'
wait $!
sleep 3
